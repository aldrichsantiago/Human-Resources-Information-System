...
export default function Sidebar() {
    ...
    function handleNavOptionsClick(textOption: string) {
        setOption(textOption)
        navigate(textOption)
    ...
    <aside id="sidebar" className="bg-gray-800 text-gray-100 md:w-64 w-3/4 space-y-8 pt-8 px-0 absolute inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out  md:flex md:flex-col md:justify-between overflow-y-auto" data-dev-hint="sidebar; px-0 for frameless; px-2 for visually inset the navigation">
        <div className="flex flex-col space-y-6" data-dev-hint="optional div for having an extra footer navigation">
            ...
            <nav data-dev-hint="main navigation">
                <a href="" onClick={
                    ()=>handleNavOptionsClick("dashboard")
                } className="flex items-center space-x-2 py-4 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
                ...
                <a href="" onClick={
                    ()=>handleNavOptionsClick("employee_information")
                } className="flex items-center space-x-2 py-4 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                ...
                <a href="" onClick={
                    ()=>handleNavOptionsClick("attendance")
                } className="flex items-center space-x-2 py-4 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <nav data-dev-hint="second-main-navigation or footer navigation">
            <a href="" 
                onClick={
                    ()=>handleNavOptionsClick("settings")
                } className="flex items-center gap-2 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <a href="" className="flex items-center gap-2 py-2 px-4 transition duration-200 hover:bg-gray-700 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
